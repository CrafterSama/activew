...
@section('content')
	...
	<div class="alert alert-info">
		A continuación encontrara una Lista de los Usuarios en el Sistema sus Rangos, fecha de Registro, asi como tambien puede Editarlos, borrarlos y ver los Pedidos de cada uno de ellos en caso de que tengan alguno. 
	</div>
	<br>
						...
						@foreach ($users as $user)
							<tr>
								...
								<td data-title="Acciones" class="text-center">
									...
									<a href="#" class="btn btn-danger btn-xs btn-delete" data-id="{{ $user->id }}" data-toggle="tooltip" data-placement="top" title="Borrar Registro" onclick="return confirm('¿Esta seguro que desea borrar este Registro?');"><i class="fa fa-trash-o fa-lg"></i></a>
								</td>
							</tr>
		    			@endforeach							
					</tbody>
  ...
  {{ Form::open(array('route'=>array('admin.usuarios.destroy', 'USER_ID'), 'method'=>'DELETE', 'role'=>'form', 'id'=>'form-delete')) }}
  {{ Form::close() }}
@stop