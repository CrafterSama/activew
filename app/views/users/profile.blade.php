	...
	<section class="panel">
	    ...
	    <div class="panel-body">
		    ...
		    <table class="table table-bordered table-striped table-condensed cf">
				...
				<tr>
					<td class="visible-lg"><strong> Direción</strong></td><td data-title="Dirección"> {{ $user->user_address }}, {{ ucwords(strtolower(Municipio::getName($user->municipio))) }}, Edo. {{ ucwords(strtolower(State::getName($user->estado))) }} </td>
				</tr>
				<tr>
